      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-12">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-saffron/10 border border-saffron/20 flex items-center justify-center shrink-0">
              <ShieldAlert className="w-5 h-5 md:w-6 md:h-6 text-saffron" />
            </div>
            <div>
              <h1 className="font-playfair text-2xl md:text-4xl font-bold text-cream">Admin Dashboard</h1>
              <p className="text-xs text-cream/40 uppercase tracking-widest mt-0.5">Raju Food Court — Branch Management</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="flex items-center gap-2 px-3 py-2 md:px-4 rounded-xl border border-gold/20 text-cream/50 hover:border-maroon/50 hover:text-maroon transition-all duration-200 text-xs font-semibold uppercase tracking-wider cursor-pointer shrink-0"
          >
        ...
        {/* Tabs */}
        <div className="flex gap-1 border-b border-gold/10 pb-0 mb-10 overflow-x-auto scrollbar-hide -mx-2 px-2">
